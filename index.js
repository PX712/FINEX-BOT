...
client.on('voiceStateUpdate', (oldM, newM) => {
  ...
  let ch = oldM.guild.channels.find('name', '🔰一log-changes')
...
if(cmd === `${prefix}sug`) {
    ...
    let suggests = message.guild.channels.find(`name`, "🔰一admins");
...
client.on("message", message => { // Leaked by [ @M3a4x ]
 ...
 client.on('guildCreate', guild => {
  client.channels.get("326099411853901824").send(`**تم اضافة البوت في سيرفر جديد مبروكك
